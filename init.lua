...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        -- To Experiment
        -- ['<CR>'] = { 'accept', 'fallback' },
        -- ['<C-n>'] = { 'select_next', 'show_and_insert', 'fallback' },
      },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'gap', 'julia' },
      ...
      highlight = {
        ...
        additional_vim_regex_highlighting = { 'ruby', 'gap', 'gaptst', 'julia' },
      },
      indent = { enable = true, disable = { 'ruby', 'gap', 'gaptst' } },
    },
  ...
  -- terminal-buffer for each buffer.
  {
